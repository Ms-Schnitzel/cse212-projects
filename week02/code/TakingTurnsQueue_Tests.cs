...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Person was enqueued to front of line, not back
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Tim was not being requeued for having endless turns with turncount 0
    ...
    // Defect(s) Found: Tim was not being requeued with a turncount of less than 0
    ...
    // Defect(s) Found: Test passed when ran
